...
the build. PocketKuma uses Playwright's Chromium CDP launch/connect paths, not the BiDi mapper.
...
- No Chrome profile or PocketKuma browser-supervisor process remained after the repeated standalone runs.
