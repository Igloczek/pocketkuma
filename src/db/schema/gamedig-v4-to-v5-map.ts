...
// Lookup table mapping GameDig v4 game IDs to v5 game IDs.
// Source: upstream Knex migration 2026-01-02-0713-gamedig-v4-to-v5.ts
// Reference: https://github.com/gamedig/node-gamedig/blob/master/MIGRATE_IDS.md
export const gameDig4to5IdMap = {
    americasarmypg: "aapg",
    "7d2d": "sdtd",
    as: "actionsource",
    ageofchivalry: "aoc",
